...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [VANILLA] = LAYOUT_tkl_ansi(
    ...
    MO(FUNC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,                                  \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSFT,               KC_UP,            \
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(FUNC), MO(FUNC), KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  ...
  [FUNC] = LAYOUT_tkl_ansi(
    ...
    _______, _______, _______,                            MU_TOG,                            _______, _______, _______, _______,           _______, _______, _______  \
  ),
  ...
  [SETTINGS] = LAYOUT_tkl_ansi(
    ...
    KC_FN5,  KC_FN2,  KC_FN4,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,               RGB_HUI,          \
